...
<div class="row">
  ...
  <div class="card card-primary">
    <div class="card-body">
        ...
        <div class="row py-2">
            <div class="col">
                <h5 class="card-title fw-semibold mb-4">ORANG TUA | <small class="fs-13 judul">Tambah Data</small></h5>
            </div>
            <div class="col ">
            </div>
        </div>
        <form method="POST" action="{{ route('user.orang-tua.store') }}">
          @csrf
        ...
        <div class="row">
                ...
                <div class="col-6">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ old('tele_id') }}" name="tele_id" id="tele_id" >
                  </div>
                  <div class="mb-3">
